...
You should already have a free account at [posit.cloud](https://posit.cloud/), following the instructions in the PDF (`BIO-6013A Posit.cloud 20250905.pdf`) that I linked to previously on Announcements. It is in the Practicals folder on BB.

After signing into Posit Cloud, join the workspace `BIO-6013A/7004A 2026` with this link:

[https://posit.cloud/spaces/808311/join?access_code=73C_hScLirPP91zeTBpJrKKtWAYDMO3QZnBGCi3k](https://posit.cloud/spaces/808311/join?access_code=73C_hScLirPP91zeTBpJrKKtWAYDMO3QZnBGCi3k)
...
```{r, eval=TRUE, echo=FALSE, out.width="90%", fig.alt= "Click on the 1-2. 6013A-Bioinformatics Skills I and II workspace", fig.cap ="Click on the 1-2. 6013A-Bioinformatics Skills I and II workspace link"}
