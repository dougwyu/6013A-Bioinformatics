...
gitcreds::gitcreds_set() # lets me add my personal access token, which gives me access to NM's repo
# choose:  "2. Replace these credentials", and paste in the new PAT. 


To edit, push to GitHub, and publish on github.io, do the following:
